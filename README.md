...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/little)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/little
```

A live public deployment of this template is available at [https://little.templates.workers.dev](https://little.templates.workers.dev)
